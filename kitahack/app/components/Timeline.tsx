...
const events: TimelineEvent[] = [
    ...
    {
        title: 'Workshop 7: "From Zero to Hero: KitaHack 2025 Champions Info Session',
        date: 'TBA',
        type: 'Workshop',
        color: colors.green,
        details: 'Get insights and tips from previous champions—practical guidance for success.',
    },
    {
