    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto">
                ...
                <div className="relative text-center space-y-8 p-8 md:p-12 rounded-[3rem] border border-white bg-black isolate">
                    ...
                    <div className="pt-4">
                        <Button
                            ...
                            size="lg"
                            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-8 py-6 text-lg rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        >
                            LEARN MORE
                        </Button>
                    </div>
