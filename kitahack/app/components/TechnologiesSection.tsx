...
const TechCard = ({ title, description, link, themeColor, icon, width, height, hideText, customIconSize }: techCardPropsType) => {
  ...
  return (
    <a
      ...
      `}
    >
      <div className={`absolute -inset-2 blur-2xl opacity-0 group-hover:opacity-40 transition-opacity duration-500 pointer-events-none ${theme.glow}`} />

      <div className={`mb-3 relative ${iconSizeClass} z-10 transition-transform duration-300 group-hover:scale-110`}>
        <Image
          src={icon}
          alt={`${title} logo`}
          fill
...
export function TechnologiesSection() {
  return (
    <section className="bg-black min-h-screen w-full flex flex-col justify-start items-center pt-12 md:pt-24 pb-10 overflow-x-hidden relative">
      ...
      <div className="container mx-auto px-4 max-w-[1400px] relative z-10">
        ...
        <div className="flex flex-col md:flex-row flex-nowrap justify-center gap-5 h-auto items-stretch w-full">
          <div className="flex flex-col justify-start gap-5 w-full md:w-auto">
            <TechCard title="Android" description="Build native mobile applications for billions of Android devices worldwide." link="https://developer.android.com" themeColor="green" icon="/logos/android.png" width="260px" height="240px" hideText={false} />
            <TechCard title="Flutter" description="Build cross-platform apps from a single codebase." link="https://flutter.dev" themeColor="cyan" icon="/logos/flutter.png" width="260px" height="160px" hideText={false} />
          </div>

          <div className="flex flex-col justify-end gap-5 w-full md:w-auto">
            <TechCard title="Google Cloud" description="A powerful cloud platform offering computing, storage, AI, and backend services." link="https://cloud.google.com" themeColor="blue" icon="/logos/cloud.png" width="260px" height="350px" hideText={false} />
          </div>
          ...
          <div className="flex flex-col justify-between items-center gap-5 w-full md:w-auto">
            ...
            <TechCard title="Google Developers" description="Official tools and resources." link="https://developers.google.com" themeColor="red" icon="/logos/google.png" width="260px" height="200px" hideText={false} />
          </div>

          <div className="flex flex-col justify-end gap-5 w-full md:w-auto">
            <TechCard title="Firebase" description="An all-in-one backend platform providing authentication, databases, and hosting." link="https://firebase.google.com" themeColor="yellow" icon="/logos/firebase.png" width="260px" height="350px" hideText={false} />
          </div>

          <div className="flex flex-col justify-start gap-5 w-full md:w-auto">
            <TechCard title="TensorFlow" description="An open-source machine learning framework used to build and deploy AI models." link="https://www.tensorflow.org" themeColor="orange" icon="/logos/tensorflow.png" width="260px" height="240px" hideText={false} />
            <TechCard title="Google AI Studio" description="Experiment and build applications using Google’s AI models." link="https://ai.google.dev/" themeColor="purple" icon="/logos/ai.png" width="260px" height="160px" hideText={false} />
          </div>
        </div>
      </div>
    </section>
